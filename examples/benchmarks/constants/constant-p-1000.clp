...
(defrule rule-701
   (data (value ?x&:(eq ?x 701)))
   =>)

(defrule rule-702
   (data (value ?x&:(eq ?x 702)))
   =>)

(defrule rule-703
   (data (value ?x&:(eq ?x 703)))
   =>)

(defrule rule-704
   (data (value ?x&:(eq ?x 704)))
   =>)

(defrule rule-705
   (data (value ?x&:(eq ?x 705)))
   =>)

(defrule rule-706
   (data (value ?x&:(eq ?x 706)))
   =>)

(defrule rule-707
   (data (value ?x&:(eq ?x 707)))
   =>)

(defrule rule-708
   (data (value ?x&:(eq ?x 708)))
   =>)

(defrule rule-709
   (data (value ?x&:(eq ?x 709)))
   =>)

(defrule rule-710
   (data (value ?x&:(eq ?x 710)))
   =>)

(defrule rule-711
   (data (value ?x&:(eq ?x 711)))
   =>)

(defrule rule-712
   (data (value ?x&:(eq ?x 712)))
   =>)

(defrule rule-713
   (data (value ?x&:(eq ?x 713)))
   =>)

(defrule rule-714
   (data (value ?x&:(eq ?x 714)))
   =>)

(defrule rule-715
   (data (value ?x&:(eq ?x 715)))
   =>)

(defrule rule-716
   (data (value ?x&:(eq ?x 716)))
   =>)

(defrule rule-717
   (data (value ?x&:(eq ?x 717)))
   =>)

(defrule rule-718
   (data (value ?x&:(eq ?x 718)))
   =>)

(defrule rule-719
   (data (value ?x&:(eq ?x 719)))
   =>)

(defrule rule-720
   (data (value ?x&:(eq ?x 720)))
   =>)

(defrule rule-721
   (data (value ?x&:(eq ?x 721)))
   =>)

(defrule rule-722
   (data (value ?x&:(eq ?x 722)))
   =>)

(defrule rule-723
   (data (value ?x&:(eq ?x 723)))
   =>)

(defrule rule-724
   (data (value ?x&:(eq ?x 724)))
   =>)

(defrule rule-725
   (data (value ?x&:(eq ?x 725)))
   =>)

(defrule rule-726
   (data (value ?x&:(eq ?x 726)))
   =>)

(defrule rule-727
   (data (value ?x&:(eq ?x 727)))
   =>)

(defrule rule-728
   (data (value ?x&:(eq ?x 728)))
   =>)

(defrule rule-729
   (data (value ?x&:(eq ?x 729)))
   =>)

(defrule rule-730
   (data (value ?x&:(eq ?x 730)))
   =>)

(defrule rule-731
   (data (value ?x&:(eq ?x 731)))
   =>)

(defrule rule-732
   (data (value ?x&:(eq ?x 732)))
   =>)

(defrule rule-733
   (data (value ?x&:(eq ?x 733)))
   =>)

(defrule rule-734
   (data (value ?x&:(eq ?x 734)))
   =>)

(defrule rule-735
   (data (value ?x&:(eq ?x 735)))
   =>)

(defrule rule-736
   (data (value ?x&:(eq ?x 736)))
   =>)

(defrule rule-737
   (data (value ?x&:(eq ?x 737)))
   =>)

(defrule rule-738
   (data (value ?x&:(eq ?x 738)))
   =>)

(defrule rule-739
   (data (value ?x&:(eq ?x 739)))
   =>)

(defrule rule-740
   (data (value ?x&:(eq ?x 740)))
   =>)

(defrule rule-741
   (data (value ?x&:(eq ?x 741)))
   =>)

(defrule rule-742
   (data (value ?x&:(eq ?x 742)))
   =>)

(defrule rule-743
   (data (value ?x&:(eq ?x 743)))
   =>)

(defrule rule-744
   (data (value ?x&:(eq ?x 744)))
   =>)

(defrule rule-745
   (data (value ?x&:(eq ?x 745)))
   =>)

(defrule rule-746
   (data (value ?x&:(eq ?x 746)))
   =>)

(defrule rule-747
   (data (value ?x&:(eq ?x 747)))
   =>)

(defrule rule-748
   (data (value ?x&:(eq ?x 748)))
   =>)

(defrule rule-749
   (data (value ?x&:(eq ?x 749)))
   =>)

(defrule rule-750
   (data (value ?x&:(eq ?x 750)))
   =>)

(defrule rule-751
   (data (value ?x&:(eq ?x 751)))
   =>)

(defrule rule-752
   (data (value ?x&:(eq ?x 752)))
   =>)

(defrule rule-753
   (data (value ?x&:(eq ?x 753)))
   =>)

(defrule rule-754
   (data (value ?x&:(eq ?x 754)))
   =>)

(defrule rule-755
   (data (value ?x&:(eq ?x 755)))
   =>)

(defrule rule-756
   (data (value ?x&:(eq ?x 756)))
   =>)

(defrule rule-757
   (data (value ?x&:(eq ?x 757)))
   =>)

(defrule rule-758
   (data (value ?x&:(eq ?x 758)))
   =>)

(defrule rule-759
   (data (value ?x&:(eq ?x 759)))
   =>)

(defrule rule-760
   (data (value ?x&:(eq ?x 760)))
   =>)

(defrule rule-761
   (data (value ?x&:(eq ?x 761)))
   =>)

(defrule rule-762
   (data (value ?x&:(eq ?x 762)))
   =>)

(defrule rule-763
   (data (value ?x&:(eq ?x 763)))
   =>)

(defrule rule-764
   (data (value ?x&:(eq ?x 764)))
   =>)

(defrule rule-765
   (data (value ?x&:(eq ?x 765)))
   =>)

(defrule rule-766
   (data (value ?x&:(eq ?x 766)))
   =>)

(defrule rule-767
   (data (value ?x&:(eq ?x 767)))
   =>)

(defrule rule-768
   (data (value ?x&:(eq ?x 768)))
   =>)

(defrule rule-769
   (data (value ?x&:(eq ?x 769)))
   =>)

(defrule rule-770
   (data (value ?x&:(eq ?x 770)))
   =>)

(defrule rule-771
   (data (value ?x&:(eq ?x 771)))
   =>)

(defrule rule-772
   (data (value ?x&:(eq ?x 772)))
   =>)

(defrule rule-773
   (data (value ?x&:(eq ?x 773)))
   =>)

(defrule rule-774
   (data (value ?x&:(eq ?x 774)))
   =>)

(defrule rule-775
   (data (value ?x&:(eq ?x 775)))
   =>)

(defrule rule-776
   (data (value ?x&:(eq ?x 776)))
   =>)

(defrule rule-777
   (data (value ?x&:(eq ?x 777)))
   =>)

(defrule rule-778
   (data (value ?x&:(eq ?x 778)))
   =>)

(defrule rule-779
   (data (value ?x&:(eq ?x 779)))
   =>)

(defrule rule-780
   (data (value ?x&:(eq ?x 780)))
   =>)

(defrule rule-781
   (data (value ?x&:(eq ?x 781)))
   =>)

(defrule rule-782
   (data (value ?x&:(eq ?x 782)))
   =>)

(defrule rule-783
   (data (value ?x&:(eq ?x 783)))
   =>)

(defrule rule-784
   (data (value ?x&:(eq ?x 784)))
   =>)

(defrule rule-785
   (data (value ?x&:(eq ?x 785)))
   =>)

(defrule rule-786
   (data (value ?x&:(eq ?x 786)))
   =>)

(defrule rule-787
   (data (value ?x&:(eq ?x 787)))
   =>)

(defrule rule-788
   (data (value ?x&:(eq ?x 788)))
   =>)

(defrule rule-789
   (data (value ?x&:(eq ?x 789)))
   =>)

(defrule rule-790
   (data (value ?x&:(eq ?x 790)))
   =>)

(defrule rule-791
   (data (value ?x&:(eq ?x 791)))
   =>)

(defrule rule-792
   (data (value ?x&:(eq ?x 792)))
   =>)

(defrule rule-793
   (data (value ?x&:(eq ?x 793)))
   =>)

(defrule rule-794
   (data (value ?x&:(eq ?x 794)))
   =>)

(defrule rule-795
   (data (value ?x&:(eq ?x 795)))
   =>)

(defrule rule-796
   (data (value ?x&:(eq ?x 796)))
   =>)

(defrule rule-797
   (data (value ?x&:(eq ?x 797)))
   =>)

(defrule rule-798
   (data (value ?x&:(eq ?x 798)))
   =>)

(defrule rule-799
   (data (value ?x&:(eq ?x 799)))
   =>)

(defrule rule-800
   (data (value ?x&:(eq ?x 800)))
   =>)

(defrule rule-801
   (data (value ?x&:(eq ?x 801)))
   =>)

(defrule rule-802
   (data (value ?x&:(eq ?x 802)))
   =>)

(defrule rule-803
   (data (value ?x&:(eq ?x 803)))
   =>)

(defrule rule-804
   (data (value ?x&:(eq ?x 804)))
   =>)

(defrule rule-805
   (data (value ?x&:(eq ?x 805)))
   =>)

(defrule rule-806
   (data (value ?x&:(eq ?x 806)))
   =>)

(defrule rule-807
   (data (value ?x&:(eq ?x 807)))
   =>)

(defrule rule-808
   (data (value ?x&:(eq ?x 808)))
   =>)

(defrule rule-809
   (data (value ?x&:(eq ?x 809)))
   =>)

(defrule rule-810
   (data (value ?x&:(eq ?x 810)))
   =>)

(defrule rule-811
   (data (value ?x&:(eq ?x 811)))
   =>)

(defrule rule-812
   (data (value ?x&:(eq ?x 812)))
   =>)

(defrule rule-813
   (data (value ?x&:(eq ?x 813)))
   =>)

(defrule rule-814
   (data (value ?x&:(eq ?x 814)))
   =>)

(defrule rule-815
   (data (value ?x&:(eq ?x 815)))
   =>)

(defrule rule-816
   (data (value ?x&:(eq ?x 816)))
   =>)

(defrule rule-817
   (data (value ?x&:(eq ?x 817)))
   =>)

(defrule rule-818
   (data (value ?x&:(eq ?x 818)))
   =>)

(defrule rule-819
   (data (value ?x&:(eq ?x 819)))
   =>)

(defrule rule-820
   (data (value ?x&:(eq ?x 820)))
   =>)

(defrule rule-821
   (data (value ?x&:(eq ?x 821)))
   =>)

(defrule rule-822
   (data (value ?x&:(eq ?x 822)))
   =>)

(defrule rule-823
   (data (value ?x&:(eq ?x 823)))
   =>)

(defrule rule-824
   (data (value ?x&:(eq ?x 824)))
   =>)

(defrule rule-825
   (data (value ?x&:(eq ?x 825)))
   =>)

(defrule rule-826
   (data (value ?x&:(eq ?x 826)))
   =>)

(defrule rule-827
   (data (value ?x&:(eq ?x 827)))
   =>)

(defrule rule-828
   (data (value ?x&:(eq ?x 828)))
   =>)

(defrule rule-829
   (data (value ?x&:(eq ?x 829)))
   =>)

(defrule rule-830
   (data (value ?x&:(eq ?x 830)))
   =>)

(defrule rule-831
   (data (value ?x&:(eq ?x 831)))
   =>)

(defrule rule-832
   (data (value ?x&:(eq ?x 832)))
   =>)

(defrule rule-833
   (data (value ?x&:(eq ?x 833)))
   =>)

(defrule rule-834
   (data (value ?x&:(eq ?x 834)))
   =>)

(defrule rule-835
   (data (value ?x&:(eq ?x 835)))
   =>)

(defrule rule-836
   (data (value ?x&:(eq ?x 836)))
   =>)

(defrule rule-837
   (data (value ?x&:(eq ?x 837)))
   =>)

(defrule rule-838
   (data (value ?x&:(eq ?x 838)))
   =>)

(defrule rule-839
   (data (value ?x&:(eq ?x 839)))
   =>)

(defrule rule-840
   (data (value ?x&:(eq ?x 840)))
   =>)

(defrule rule-841
   (data (value ?x&:(eq ?x 841)))
   =>)

(defrule rule-842
   (data (value ?x&:(eq ?x 842)))
   =>)

(defrule rule-843
   (data (value ?x&:(eq ?x 843)))
   =>)

(defrule rule-844
   (data (value ?x&:(eq ?x 844)))
   =>)

(defrule rule-845
   (data (value ?x&:(eq ?x 845)))
   =>)

(defrule rule-846
   (data (value ?x&:(eq ?x 846)))
   =>)

(defrule rule-847
   (data (value ?x&:(eq ?x 847)))
   =>)

(defrule rule-848
   (data (value ?x&:(eq ?x 848)))
   =>)

(defrule rule-849
   (data (value ?x&:(eq ?x 849)))
   =>)

(defrule rule-850
   (data (value ?x&:(eq ?x 850)))
   =>)

(defrule rule-851
   (data (value ?x&:(eq ?x 851)))
   =>)

(defrule rule-852
   (data (value ?x&:(eq ?x 852)))
   =>)

(defrule rule-853
   (data (value ?x&:(eq ?x 853)))
   =>)

(defrule rule-854
   (data (value ?x&:(eq ?x 854)))
   =>)

(defrule rule-855
   (data (value ?x&:(eq ?x 855)))
   =>)

(defrule rule-856
   (data (value ?x&:(eq ?x 856)))
   =>)

(defrule rule-857
   (data (value ?x&:(eq ?x 857)))
   =>)

(defrule rule-858
   (data (value ?x&:(eq ?x 858)))
   =>)

(defrule rule-859
   (data (value ?x&:(eq ?x 859)))
   =>)

(defrule rule-860
   (data (value ?x&:(eq ?x 860)))
   =>)

(defrule rule-861
   (data (value ?x&:(eq ?x 861)))
   =>)

(defrule rule-862
   (data (value ?x&:(eq ?x 862)))
   =>)

(defrule rule-863
   (data (value ?x&:(eq ?x 863)))
   =>)

(defrule rule-864
   (data (value ?x&:(eq ?x 864)))
   =>)

(defrule rule-865
   (data (value ?x&:(eq ?x 865)))
   =>)

(defrule rule-866
   (data (value ?x&:(eq ?x 866)))
   =>)

(defrule rule-867
   (data (value ?x&:(eq ?x 867)))
   =>)

(defrule rule-868
   (data (value ?x&:(eq ?x 868)))
   =>)

(defrule rule-869
   (data (value ?x&:(eq ?x 869)))
   =>)

(defrule rule-870
   (data (value ?x&:(eq ?x 870)))
   =>)

(defrule rule-871
   (data (value ?x&:(eq ?x 871)))
   =>)

(defrule rule-872
   (data (value ?x&:(eq ?x 872)))
   =>)

(defrule rule-873
   (data (value ?x&:(eq ?x 873)))
   =>)

(defrule rule-874
   (data (value ?x&:(eq ?x 874)))
   =>)

(defrule rule-875
   (data (value ?x&:(eq ?x 875)))
   =>)

(defrule rule-876
   (data (value ?x&:(eq ?x 876)))
   =>)

(defrule rule-877
   (data (value ?x&:(eq ?x 877)))
   =>)

(defrule rule-878
   (data (value ?x&:(eq ?x 878)))
   =>)

(defrule rule-879
   (data (value ?x&:(eq ?x 879)))
   =>)

(defrule rule-880
   (data (value ?x&:(eq ?x 880)))
   =>)

(defrule rule-881
   (data (value ?x&:(eq ?x 881)))
   =>)

(defrule rule-882
   (data (value ?x&:(eq ?x 882)))
   =>)

(defrule rule-883
   (data (value ?x&:(eq ?x 883)))
   =>)

(defrule rule-884
   (data (value ?x&:(eq ?x 884)))
   =>)

(defrule rule-885
   (data (value ?x&:(eq ?x 885)))
   =>)

(defrule rule-886
   (data (value ?x&:(eq ?x 886)))
   =>)

(defrule rule-887
   (data (value ?x&:(eq ?x 887)))
   =>)

(defrule rule-888
   (data (value ?x&:(eq ?x 888)))
   =>)

(defrule rule-889
   (data (value ?x&:(eq ?x 889)))
   =>)

(defrule rule-890
   (data (value ?x&:(eq ?x 890)))
   =>)

(defrule rule-891
   (data (value ?x&:(eq ?x 891)))
   =>)

(defrule rule-892
   (data (value ?x&:(eq ?x 892)))
   =>)

(defrule rule-893
   (data (value ?x&:(eq ?x 893)))
   =>)

(defrule rule-894
   (data (value ?x&:(eq ?x 894)))
   =>)

(defrule rule-895
   (data (value ?x&:(eq ?x 895)))
   =>)

(defrule rule-896
   (data (value ?x&:(eq ?x 896)))
   =>)

(defrule rule-897
   (data (value ?x&:(eq ?x 897)))
   =>)

(defrule rule-898
   (data (value ?x&:(eq ?x 898)))
   =>)

(defrule rule-899
   (data (value ?x&:(eq ?x 899)))
   =>)

(defrule rule-900
   (data (value ?x&:(eq ?x 900)))
   =>)

(defrule rule-901
   (data (value ?x&:(eq ?x 901)))
   =>)

(defrule rule-902
   (data (value ?x&:(eq ?x 902)))
   =>)

(defrule rule-903
   (data (value ?x&:(eq ?x 903)))
   =>)

(defrule rule-904
   (data (value ?x&:(eq ?x 904)))
   =>)

(defrule rule-905
   (data (value ?x&:(eq ?x 905)))
   =>)

(defrule rule-906
   (data (value ?x&:(eq ?x 906)))
   =>)

(defrule rule-907
   (data (value ?x&:(eq ?x 907)))
   =>)

(defrule rule-908
   (data (value ?x&:(eq ?x 908)))
   =>)

(defrule rule-909
   (data (value ?x&:(eq ?x 909)))
   =>)

(defrule rule-910
   (data (value ?x&:(eq ?x 910)))
   =>)

(defrule rule-911
   (data (value ?x&:(eq ?x 911)))
   =>)

(defrule rule-912
   (data (value ?x&:(eq ?x 912)))
   =>)

(defrule rule-913
   (data (value ?x&:(eq ?x 913)))
   =>)

(defrule rule-914
   (data (value ?x&:(eq ?x 914)))
   =>)

(defrule rule-915
   (data (value ?x&:(eq ?x 915)))
   =>)

(defrule rule-916
   (data (value ?x&:(eq ?x 916)))
   =>)

(defrule rule-917
   (data (value ?x&:(eq ?x 917)))
   =>)

(defrule rule-918
   (data (value ?x&:(eq ?x 918)))
   =>)

(defrule rule-919
   (data (value ?x&:(eq ?x 919)))
   =>)

(defrule rule-920
   (data (value ?x&:(eq ?x 920)))
   =>)

(defrule rule-921
   (data (value ?x&:(eq ?x 921)))
   =>)

(defrule rule-922
   (data (value ?x&:(eq ?x 922)))
   =>)

(defrule rule-923
   (data (value ?x&:(eq ?x 923)))
   =>)

(defrule rule-924
   (data (value ?x&:(eq ?x 924)))
   =>)

(defrule rule-925
   (data (value ?x&:(eq ?x 925)))
   =>)

(defrule rule-926
   (data (value ?x&:(eq ?x 926)))
   =>)

(defrule rule-927
   (data (value ?x&:(eq ?x 927)))
   =>)

(defrule rule-928
   (data (value ?x&:(eq ?x 928)))
   =>)

(defrule rule-929
   (data (value ?x&:(eq ?x 929)))
   =>)

(defrule rule-930
   (data (value ?x&:(eq ?x 930)))
   =>)

(defrule rule-931
   (data (value ?x&:(eq ?x 931)))
   =>)

(defrule rule-932
   (data (value ?x&:(eq ?x 932)))
   =>)

(defrule rule-933
   (data (value ?x&:(eq ?x 933)))
   =>)

(defrule rule-934
   (data (value ?x&:(eq ?x 934)))
   =>)

(defrule rule-935
   (data (value ?x&:(eq ?x 935)))
   =>)

(defrule rule-936
   (data (value ?x&:(eq ?x 936)))
   =>)

(defrule rule-937
   (data (value ?x&:(eq ?x 937)))
   =>)

(defrule rule-938
   (data (value ?x&:(eq ?x 938)))
   =>)

(defrule rule-939
   (data (value ?x&:(eq ?x 939)))
   =>)

(defrule rule-940
   (data (value ?x&:(eq ?x 940)))
   =>)

(defrule rule-941
   (data (value ?x&:(eq ?x 941)))
   =>)

(defrule rule-942
   (data (value ?x&:(eq ?x 942)))
   =>)

(defrule rule-943
   (data (value ?x&:(eq ?x 943)))
   =>)

(defrule rule-944
   (data (value ?x&:(eq ?x 944)))
   =>)

(defrule rule-945
   (data (value ?x&:(eq ?x 945)))
   =>)

(defrule rule-946
   (data (value ?x&:(eq ?x 946)))
   =>)

(defrule rule-947
   (data (value ?x&:(eq ?x 947)))
   =>)

(defrule rule-948
   (data (value ?x&:(eq ?x 948)))
   =>)

(defrule rule-949
   (data (value ?x&:(eq ?x 949)))
   =>)

(defrule rule-950
   (data (value ?x&:(eq ?x 950)))
   =>)

(defrule rule-951
   (data (value ?x&:(eq ?x 951)))
   =>)

(defrule rule-952
   (data (value ?x&:(eq ?x 952)))
   =>)

(defrule rule-953
   (data (value ?x&:(eq ?x 953)))
   =>)

(defrule rule-954
   (data (value ?x&:(eq ?x 954)))
   =>)

(defrule rule-955
   (data (value ?x&:(eq ?x 955)))
   =>)

(defrule rule-956
   (data (value ?x&:(eq ?x 956)))
   =>)

(defrule rule-957
   (data (value ?x&:(eq ?x 957)))
   =>)

(defrule rule-958
   (data (value ?x&:(eq ?x 958)))
   =>)

(defrule rule-959
   (data (value ?x&:(eq ?x 959)))
   =>)

(defrule rule-960
   (data (value ?x&:(eq ?x 960)))
   =>)

(defrule rule-961
   (data (value ?x&:(eq ?x 961)))
   =>)

(defrule rule-962
   (data (value ?x&:(eq ?x 962)))
   =>)

(defrule rule-963
   (data (value ?x&:(eq ?x 963)))
   =>)

(defrule rule-964
   (data (value ?x&:(eq ?x 964)))
   =>)

(defrule rule-965
   (data (value ?x&:(eq ?x 965)))
   =>)

(defrule rule-966
   (data (value ?x&:(eq ?x 966)))
   =>)

(defrule rule-967
   (data (value ?x&:(eq ?x 967)))
   =>)

(defrule rule-968
   (data (value ?x&:(eq ?x 968)))
   =>)

(defrule rule-969
   (data (value ?x&:(eq ?x 969)))
   =>)

(defrule rule-970
   (data (value ?x&:(eq ?x 970)))
   =>)

(defrule rule-971
   (data (value ?x&:(eq ?x 971)))
   =>)

(defrule rule-972
   (data (value ?x&:(eq ?x 972)))
   =>)

(defrule rule-973
   (data (value ?x&:(eq ?x 973)))
   =>)

(defrule rule-974
   (data (value ?x&:(eq ?x 974)))
   =>)

(defrule rule-975
   (data (value ?x&:(eq ?x 975)))
   =>)

(defrule rule-976
   (data (value ?x&:(eq ?x 976)))
   =>)

(defrule rule-977
   (data (value ?x&:(eq ?x 977)))
   =>)

(defrule rule-978
   (data (value ?x&:(eq ?x 978)))
   =>)

(defrule rule-979
   (data (value ?x&:(eq ?x 979)))
   =>)

(defrule rule-980
   (data (value ?x&:(eq ?x 980)))
   =>)

(defrule rule-981
   (data (value ?x&:(eq ?x 981)))
   =>)

(defrule rule-982
   (data (value ?x&:(eq ?x 982)))
   =>)

(defrule rule-983
   (data (value ?x&:(eq ?x 983)))
   =>)

(defrule rule-984
   (data (value ?x&:(eq ?x 984)))
   =>)

(defrule rule-985
   (data (value ?x&:(eq ?x 985)))
   =>)

(defrule rule-986
   (data (value ?x&:(eq ?x 986)))
   =>)

(defrule rule-987
   (data (value ?x&:(eq ?x 987)))
   =>)

(defrule rule-988
   (data (value ?x&:(eq ?x 988)))
   =>)

(defrule rule-989
   (data (value ?x&:(eq ?x 989)))
   =>)

(defrule rule-990
   (data (value ?x&:(eq ?x 990)))
   =>)

(defrule rule-991
   (data (value ?x&:(eq ?x 991)))
   =>)

(defrule rule-992
   (data (value ?x&:(eq ?x 992)))
   =>)

(defrule rule-993
   (data (value ?x&:(eq ?x 993)))
   =>)

(defrule rule-994
   (data (value ?x&:(eq ?x 994)))
   =>)

(defrule rule-995
   (data (value ?x&:(eq ?x 995)))
   =>)

(defrule rule-996
   (data (value ?x&:(eq ?x 996)))
   =>)

(defrule rule-997
   (data (value ?x&:(eq ?x 997)))
   =>)

(defrule rule-998
   (data (value ?x&:(eq ?x 998)))
   =>)

(defrule rule-999
   (data (value ?x&:(eq ?x 999)))
   =>)

(defrule rule-1000
   (data (value ?x&:(eq ?x 1000)))
   =>)
